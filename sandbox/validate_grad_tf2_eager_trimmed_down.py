...
if __name__ == "__main__":
    ...
    print(f"grad/l1/weights: {a_grads[0]}")
    print(f"grad/l1/bias: {a_grads[1]}")
    print(f"grad/l2/weights: {a_grads[2]}")
    print(f"grad/l2/bias: {a_grads[3]}")
    print(f"grad/mu/weights: {a_grads[4]}")
    print(f"grad/mu/bias: {a_grads[5]}")
    print(f"grad/log_sigma/weights: {a_grads[6]}")
    ...
    print(f"grad/l1/w1_s: {l_grads[2]}")
    print(f"grad/l1/w1_a: {l_grads[3]}")
    print(f"grad/l1/b1: {l_grads[4]}")
    print(f"grad/l2/weights: {l_grads[0]}")
    print(f"grad/l2/bias: {l_grads[1]}")
