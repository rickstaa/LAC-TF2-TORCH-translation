...
def get_train(name):
    if "LAC" in name:
        from LAC.LAC_V1_translated_fully_translated_ga import train
    return train
...
def get_policy(name):
    ...
    if "LAC" in name:
        from LAC.LAC_V1_translated_fully_translated_ga import LAC as build_func
    elif "LQR" in name:
...
def get_eval(name):
    if "LAC" in name or "SAC_cost" in name:
        from LAC.LAC_V1_translated_fully_translated_ga import eval
